...
#define literal(name, value)                                                                       \
    ...
    literal("pandoraBox", "Pandora's Box");
    literal("refugeeCamp", "Refugee Camp");
    literal("warMachineFactory", "War Machine Factory");
    literal("obelisk", "Obelisk");
    literal("denOfThieves", "Den of Thieves");
    literal("randomArtifactTreasure", "Random Treasure Artifact");
    literal("randomArtifactMinor", "Random Minor Artifact");
    literal("randomArtifactMajor", "Random Major Artifact");
    literal("randomArtifactRelic", "Random Relic");
    literal("hillFort", "Hill Fort");
    literal("tavern", "Tavern");
    literal("sanctuary", "Sanctuary");
    literal("cyclopsStockpile", "Cyclops Stockpile");
    literal("dwarvenTreasury", "Dwarven Treasury");
    literal("griffinConservatory", "Griffin Conservatory");
    literal("impCache", "Imp Cache");
    literal("medusaStore", "Medusa Stores");
    literal("nagaBank", "Naga Bank");
    literal("dragonFlyHive", "Dragon Fly Hive");
    literal("crypt", "Crypt_Dirt");
    literal("dragonUtopia", "Dragon Utopia");
    literal("wagon", "Wagon_Rough");
    literal("warriorTomb", "Warrior's Tomb");
    literal("campfire", "Campfire");
    literal("treasureChest", "Treasure Chest");
    literal("mysticalGarden", "Mystical Garden_Dirt");
    literal("windmill", "Windmill");
    literal("waterWheel", "Water Wheel");
    literal("arena", "Arena");
    literal("marlettoTower", "Marletto Tower");
    literal("gardenOfRevelation", "Garden of Knowledge");
    literal("libraryOfEnlightenment", "Library of Enlightenment");
    literal("mercenaryCamp", "Mercenary Camp");
    literal("starAxis", "Star Axis");
    literal("treeOfKnowledge", "Tree of Knowledge");
    literal("schoolOfMagic", "School of Magic");
    literal("schoolOfWar", "School of War");
    literal("learningStone", "Learning Stone");
    literal("swanPond", "Swan Pond");
    literal("faerieRing", "Faerie Ring_Dirt");
    literal("fountainOfFortune", "Fountain of Fortune");
    literal("fountainOfYouth", "Fountain of Youth");
    literal("idolOfFortune", "Idol of Fortune");
    literal("oasis", "Oasis");
    literal("stables", "Stables_Dirt");
